...
ax.plot(n20_all, Height, "black", marker="*",
        label="All", linewidth=4.33, markersize=12)
ax.plot(n20_develop, Height, "g", marker="^",
        label="Pre-MT", linewidth=4.33, markersize=12)
ax.plot(n20_mature, Height, "r", marker="s",
        label="MT", linewidth=4.33, markersize=12)
ax.plot(n20_dissi, Height, "b", marker="o",
...
ax.set_xlim(0, 1850)
ax.text(0.05, 0.9, "(c)", transform=ax.transAxes, fontsize=50)
...
plt.savefig(f"C:\\Users\\lvyih\\Desktop\\Vertical_Profile_n20.jpeg", bbox_inches="tight", dpi=400)
"""ax.text(
        0.2, 0.1, 'some text',
