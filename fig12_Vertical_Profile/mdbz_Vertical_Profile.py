...
def read_shuju():
    ...
    flashrate = np.divide(60 * flashcount, viewtime)
...
# stage_all = duqu_excel_julei(r"C:\Users\lvyih\Desktop\stage_all.xlsx")
...
# data_all = for_(data_all, stage_2)
data1 = for_(data, stage1)
data2 = for_(data, stage2)
data3 = for_(data, stage3)
# data_all = for_(data_all, stage_all)
# print(np.mean(data_all[3]))
print(np.median(data1[3]))
print(np.median(data2[3]))
print(np.median(data3[3]))
...
ax.set_xlim(0, 54.5)
ax.set_ylim(0, 21)
ax.text(0.05, 0.9, "(a)", transform=ax.transAxes, fontsize=50)
# n20_all = data[0]
# n40_all = data[1]
# n20_develop = data1[0]
# n40_develop = data1[1]
...
plt.savefig(f"C:\\Users\\lvyih\\Desktop\\Vertical_Profile_mdbz.jpeg", bbox_inches="tight", dpi=400)
"""ax.text(
        0.2, 0.1, 'some text',
