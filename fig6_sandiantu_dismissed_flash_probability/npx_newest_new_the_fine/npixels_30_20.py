...
npixels30_mid = four_seven_eight(npixels_30)
npixels20_mid = four_seven_eight(npixels_20)
npixels20_40 = npixels20_mid[0]
npixels20_80 = npixels20_mid[1]
npixels30_40 = npixels30_mid[0]
npixels30_80 = npixels30_mid[1]
ax = fig.add_subplot(1, 1, 1)
w = 0
hh = 0
npixels30, npixels20, _color_, allshuju = color_characterized(flashcount, npixels_30, npixels_20, w, hh)
ax.scatter(npixels30, npixels20, s=2, color=_color_, marker=".")
ax.vlines(npixels30_40, 0, 2000, linestyles="dashed", color="black", label="50%")
ax.vlines(npixels30_80, 0, 2000, linestyles="dashed", color="red", label="80%")
# 创建绘制等值线图
x = np.arange(0, 1500, 25)
...
for i in y:
    ...
    for j in x:
        mid = 0
        for (u, v) in zip(npixels_30, npixels_20):
...
ax.set_xlabel("Npx30/km$^{2}$", fontsize=14)
ax.set_ylabel("Npx20/km$^{2}$", fontsize=14)
