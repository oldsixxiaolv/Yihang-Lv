...
def read_shuju(former, latter):
    ...
    ellipsoidal_ratio_30 = np.divide(maxdbz20_minus_maxdbz40, npixels_20_R)
    ellipsoidal_ratio_40 = np.divide(maxdbz20_minus_maxdbz40, npixels_20_R,
    ...
    ellipsoidal_ratio_20 = ellipsoidal_ratio_20[inded]
    ellipsoidal_ratio_30 = ellipsoidal_ratio_30[inded]
    ellipsoidal_ratio_40 = ellipsoidal_ratio_40[inded]
    return flashcount, ellipsoidal_ratio_20, ellipsoidal_ratio_30, ellipsoidal_ratio_40
...
print("first")
flashcount = data_test[0]
ellipsoidal_ratio_20 = data_test[1]
ellipsoidal_ratio_30 = data_test[2]
ellipsoidal_ratio_40 = data_test[3]
ellipsoidal_ratio_30_mid = four_seven_eight(ellipsoidal_ratio_30)
ellipsoidal_ratio_20_mid = four_seven_eight(ellipsoidal_ratio_20)
ellipsoidal_ratio_20_40 = ellipsoidal_ratio_20_mid[0]
ellipsoidal_ratio_20_80 = ellipsoidal_ratio_20_mid[1]
ellipsoidal_ratio_30_40 = ellipsoidal_ratio_30_mid[0]
ellipsoidal_ratio_30_80 = ellipsoidal_ratio_30_mid[1]
ax = fig.add_subplot(1, 1, 1)
print("second")
w = 0
hh = 0
max30, max20, _color_, allshuju = color_characterized(flashcount,
                                                      ellipsoidal_ratio_30, ellipsoidal_ratio_20, w, hh)
ax.scatter(max30, max20, s=2, color=_color_, marker=".")
ax.vlines(ellipsoidal_ratio_30_40, 0, 1, linestyles="dashed", color="black", label="40%")
ax.vlines(ellipsoidal_ratio_30_80, 0, 1, linestyles="dashed", color="red", label="80%")
print("third")
# 创建绘制等值线图
# 创建绘制等值线图
...
for i in y:
    ...
    for j in x:
        mid = 0
        for (u, v) in zip(ellipsoidal_ratio_30, ellipsoidal_ratio_20):
            if abs(i - v) <= 0.025 and abs(j - u) <= 0.025:
                mid += 1
...
# plt.clabel(axx, levels=[1500, 3000], inline=True, colors="black", fontsize=10)
# fig.colorbar(axx, ax=ax, extend="both")
ax.set_xlabel("ellipsoidal30/km", fontsize=14)
ax.set_ylabel("ellipsoidal20/km", fontsize=14)
...
ax.minorticks_on()
# 这是打开次刻度的代码
plt.savefig(r"C:\\Users\\lvyih\\Desktop\\all_stage_npx.jpeg", dpi=400)