...
maxht20_mid = four_seven_eight(maxht20)
maxht20_40 = maxht20_mid[0]
maxht20_80 = maxht20_mid[1]
maxht30_40 = maxht30_mid[0]
maxht30_80 = maxht30_mid[1]
ax = fig.add_subplot(1, 1, 1)
print("second")
w = 0
max30, max20, _color_, allshuju = color_characterized(flashcount, maxht30, maxht20, w)
ax.scatter(max30, max20, s=2, color=_color_, marker=".")
ax.vlines(maxht30_40, 0, 20, linestyles="dashed", color="black", label="40%")
ax.vlines(maxht30_80, 0, 20, linestyles="dashed", color="red", label="80%")
print("third")
# 创建绘制等值线图
...
for i in y:
    two_scale = []
    for j in x:
        indexx = list(np.where(maxht20 == i))
        indexxx = list(np.where(maxht30 == j))
...
plt.clabel(axx, levels=[400, 800], inline=True, colors="black", fontsize=10)
# fig.colorbar(axx, ax=ax, extend="both")
ax.set_xlabel("Maxht30/km", fontsize=14)
ax.set_ylabel("Maxht20/km", fontsize=14)
...
ax.minorticks_on()
# 这是打开次刻度的代码
plt.savefig(r"C:\\Users\\lvyih\\Desktop\\all_stage.jpeg", dpi=400)
