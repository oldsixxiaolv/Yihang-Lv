...
ax.text(-9, -15, f"{round(round(len(lat)/135089, 2) * 100)}%",
                    font={"family": "Times New Roman",
                          "size": 40, "weight": "bold"})
ax.text(-19, 24, "(b)", font={"family": "Times New Roman", "size": 50, "weight": "bold"})
# ax.set_title("Tropical africa Single-cell storm distribution", font={"family": "Times New Roman", "size": 35})
# fig.colorbar(ax1, ax=ax, extend="neither")
plt.tight_layout()
plt.savefig(r"C:\Users\lvyih\Desktop\Tropical_africa_Single_cell_distribution.jpeg", bbox_inches="tight", dpi=500)
