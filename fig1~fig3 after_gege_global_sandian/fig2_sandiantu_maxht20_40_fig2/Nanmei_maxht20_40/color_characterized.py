...
def color_characterized(ht40, ht20, w):
    ...
    for i in list(set(htt40)):
        for j in list(set(htt20)):
            ...
            if density_all_first < 20:
                continue
            density_output_first = density_all_first / 134010
    ...
    for i in list(set(htt40)):
        for j in list(set(htt20)):
            ...
            if density_all < 20:
                continue
            density_output = density_all / 134010
    ...
    return return_one, return_two, return_three, all_shuju, \
        den_10 * 134010, den_20 * 134010, den_30 * 134010, \
        den_40 * 134010, den_50 * 134010, den_60 * 134010, den_70 * 134010, \
        den_80 * 134010, den_90 * 134010
