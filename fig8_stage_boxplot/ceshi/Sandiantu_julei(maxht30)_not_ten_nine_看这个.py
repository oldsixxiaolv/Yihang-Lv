...
for j in range(1, 7):
    ...
    Pre_Maturity = Pre_Maturity[ten_nine(Pre_Maturity, 0, 0.9)]
    Maturity = data2[j]
    Maturity = Maturity[ten_nine(Maturity, 0.1, 0.99)]
    # Post_Maturity = data4[j]
    Dissipation = data3[j]
    Dissipation = Dissipation[ten_nine(Dissipation, 0, 0.99)]
    ...
    ax.text(0.04, 0.9, abcdef[j-1], transform=ax.transAxes, fontsize=30)
    mid += 1
