...
def read_shuju():
    ...
    return flashrate, maxht30, npixels_30
...
coefficient = 0
abcd = ["(a)", "(b)", "(c)", "(d)"]
fig = plt.figure(coefficient, figsize=(24, 10))
